...
#### 1. `policy_text_extraction_pipeline.py`  —  Stage 1: Text Extraction & Structuring
...
#### 2. `policy_sentiment_scoring_pipeline.py`  —  Stage 2: LLM-Based Sentiment Scoring
...
#### 3. `policy_period_comparison_analysis.py`  —  Stage 3: Cross-Period Comparison & Visualisation
